...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-casino-dark to-casino-black flex items-center justify-center p-4">
      <div className="card max-w-md w-full p-8">
        <div className="text-center mb-8">
          <h1 className="font-display text-3xl font-bold gold-text mb-2">
            ♠ Tournament Manager
          </h1>
          <p className="text-gray-400">Sign in to access host features</p>
        </div>
        ...
        <div className="mt-6 text-center text-sm text-gray-500">
          <p>Public displays remain accessible without login</p>
        </div>
      </div>
    </div>
  );
